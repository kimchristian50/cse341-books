 ...
 *       400:
 *         description: Missing required field, duplicate book ID, or invalid author ID.
 *       500:
 *         description: Internal server error.
 */
 ...
 *       400:
 *         description: Missing required field or invalid author ID.
 *       404:
 *         description: Book not found.
 *       500:
 *         description: Internal server error.
 ...
 *     description: Deletes a book by its custom ID.
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
